...
class Ewave_Temando_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    /**
     * Returns currently used version of plugin
     * 
     * @deprecated Assume always version 2.0
     * @return boolean 
     */
...
//    /**
//     * Returns names of locations holding stock of a product
//     * 
//     * @param int $productId
...
//    {
//	$collection = Mage::getModel('temando/inventory')->getCollection();
//	/* @var $collection Ewave_Temando_Model_Mysql4_Inventory_Collection */
//	$collection->addFieldToFilter('product_id', $productId)->load();
//	$whsIds = $collection->getColumnValues('warehouse_id');
//	
//	$locations = Mage::getModel('temando/warehouse')->getCollection();
//	/* @var $locations Ewave_Temando_Model_Mysql4_Warehouse_Collection */
//	$locations->addFieldToFilter('id', array('in' => $whsIds))->load();
//	
//	return $locations->getColumnValues('name');
//    }
