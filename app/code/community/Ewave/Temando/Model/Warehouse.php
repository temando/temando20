...
class Ewave_Temando_Model_Warehouse extends Mage_Core_Model_Abstract {
    ...
    /**
     * Products available in this warehouse (unserialized array)
     * 
     * @var array 
     */
    protected $_whsProducts = null;
    ...
    /**
     * Returns true if warehouse keeps stock of given product
     * 
     * @param int $productId 
     * @return bool  
     */
    ...
    {
	$products = $this->_getWarehouseProducts();	
	return array_key_exists($productId, $products);
    }
    
    /**
     * Returns true if warehouse keeps stock of all given products
     * 
     * @param array $productIds
     * @return boolean 
     */
    public function hasProducts($productIds)
    {
	$products = $this->_getWarehouseProducts();
    ...
    /**
     * Returns all products IDs which this warehouse keeps stock of from given list
     * 
     * @param array $productIds List of product IDs to check
     * @return array All products IDs which this warehouse keeps stock of 
     */
    public function getAvailableProducts($productIds)
    {
	$available = array();
	foreach($productIds as $productId) {
    ...
    /**
     * Returns products IDs of all products available in this warehouse
     * 
     * @return array 
     */
    private function _getWarehouseProducts()
    {
	if(is_null($this->_whsProducts)) {
	    $this->_whsProducts = unserialize($this->getWhsProducts());
	}
	
	return $this->_whsProducts;
    }
