...
class Ewave_Temando_Model_Quote extends Mage_Core_Model_Abstract
{
     ...
     * API.
     */
    public function loadResponse(stdClass $response, $packaging = null, $warehouse_id = null)
    {
		...
		->setPickupTotalPrice(array_key_exists('pickupservice', $extras_array) ? $extras_array['pickupservice']['totalPrice'] : 0)
