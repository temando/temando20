...
class Ewave_Temando_Model_Quote_Address extends Mage_Sales_Model_Quote_Address {
    ...
    public function requestShippingRates(Mage_Sales_Model_Quote_Item_Abstract $item = null)
    {
	    ...
	    if($combinedRate = Mage::getSingleton('checkout/session')->getData('combined_rate', null)){
		$shippingRates[] = $combinedRate;
	    }
