 ...
 * @method int getIsSplit()
 * @method string getCombinedRate()
 * @method string getShippingInstructions()
 * @method string getCustomerComment()
 *
 * @method Ewave_Temando_Model_Shipment setId()
 * @method Ewave_Temando_Model_Shipment setOrderId()
 * @method Ewave_Temando_Model_Shipment setCustomerSelectedQuoteId()
 * @method Ewave_Temando_Model_Shipment setCustomerSelectedQuoteDescription()
 * @method Ewave_Temando_Model_Shipment setAdminSelectedQuoteId()
 * @method Ewave_Temando_Model_Shipment setAnticipatedCost()
 * @method Ewave_Temando_Model_Shipment setStatus()
 * @method Ewave_Temando_Model_Shipment setBookingRequestId()
 * @method Ewave_Temando_Model_Shipment setDestinationCountry()
 * @method Ewave_Temando_Model_Shipment setDestinationPostcode()
 * @method Ewave_Temando_Model_Shipment setDestinationCity()
 * @method Ewave_Temando_Model_Shipment setReadyDate()
 * @method Ewave_Temando_Model_Shipment setReadyTime()
 * @method Ewave_Temando_Model_Shipment setCustomerSelectedOptions()
 * @method Ewave_Temando_Model_Shipment setIsSplit()
 * @method Ewave_Temando_Model_Shipment setCombinedRate()
 * @method Ewave_Temando_Model_Shipment setShippingInstructions()
 * @method Ewave_Temando_Model_Shipment setCustomerComment()
 *
 */
class Ewave_Temando_Model_Shipment extends Mage_Core_Model_Abstract
{
    ...
    public function getSelectedQuote()
    {
        ...
        switch ($this->getStatus()) {
            case Ewave_Temando_Model_System_Config_Source_Shipment_Status::BOOKED:
                $quote = Mage::getModel('temando/quote')
                    ->load($this->getAdminSelectedQuoteId());
                break;
            case Ewave_Temando_Model_System_Config_Source_Shipment_Status::CANCELLED:
            case Ewave_Temando_Model_System_Config_Source_Shipment_Status::PENDING:
            default:
                $quote = Mage::getModel('temando/quote')
    ...
    public function getSelectedQuotePermutation()
    {
        ...
        if ($quote !== null) {
            ...
            /* @var $options Ewave_Temando_Model_Options */
	...
	if(Mage::helper('temando')->isVersion2()) {
	    ...
	    $origin = Mage::getModel('temando/warehouse')->load($this->getWarehouseId());
	    $desc = $origin->getName();
	} else {
	...
	$delivery_options = explode(',',$this->getCustomerSelectedDeliveryOptions());
    ...
    public function getQuotes($use_options = false)
    {
        if ($use_options) {
            ...
            /* @var $quotes Ewave_Temando_Model_Mysql4_Quote_Collection */
    ...
    public function getOptions()
    {
		...
		$option = false;
            ...
            if ($option) {
                /* @var $option Ewave_Temando_Model_Option_Abstract */
