...
class Ewave_Temando_Model_Rule extends Mage_Core_Model_Abstract
{
    ...
    {
	return $this->getActionRateType() == Ewave_Temando_Model_System_Config_Source_Rule_Type::FLATRATE ||
	       $this->getActionRateType() == Ewave_Temando_Model_System_Config_Source_Rule_Type::FREE;
    }
